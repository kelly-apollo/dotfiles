...
FILES_TO_SYMLINK="$FILES_TO_SYMLINK bin .tmuxinator .proxychains"
FILES_TO_SYMLINK="$FILES_TO_SYMLINK .config/fish/config.fish .config/fish/custom"
FILES_TO_SYMLINK="$FILES_TO_SYMLINK .config/flake8"
